...
data2025 <- read.csv("Budapest2025q1.csv")
data2024 <- read.csv("Budapest2024q4.csv")
...
write.csv(data2024, 'Budapest2024q4_cleaned.csv')
write.csv(data2025, 'Budapest2025q1_cleaned.csv')
